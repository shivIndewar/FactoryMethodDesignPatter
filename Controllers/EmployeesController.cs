...
namespace EmployeePortal.Controllers
{
    public class EmployeesController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Department,Number,JobDescription,HourlyPay,Bonus,EmployeeTypeID")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Department,Number,JobDescription,HourlyPay,Bonus,EmployeeTypeID")] Employee employee)
        {
            if (ModelState.IsValid)
            {
